...
public class Home extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv4 = (TextView) findViewById(R.id.dob);
        tv5 = (TextView) findViewById(R.id.city2);
        iv1 = (ImageView) findViewById(R.id.photo2);
        ...
        //0name, 1phone, 2email, 3pass, 4photo, 5dob, 6city
